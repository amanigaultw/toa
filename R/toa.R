...
#'
#' \code{toa} performs transcript origin analysis without bootstrapped estimates of mean diagnosticity scores.
#'
...
#' \enumerate{
#'   \item a summary table \code{df.means}.
#'   \item a raw coefficients data frame \code{df.DEG}.
#' }
#' @examples
#' #load example data
#' data("Chang")
